...
import exportJsonData from "../../utils/export-json-data";
...
const ViewSales = ({ location }) => {
    ...
    const handleExportClick = () => {
        exportJsonData(results, "Sales", `all-sales.xlsx`);
    };
    ...
    const deleteAllSales = async (id) => {
        try {
            ...
            let response = await axios.delete(
                `${baseURL}/sales/delete-all-sales`
            );
            setMessage(response.data.message);
            setResults([]);
        } catch (err) {
                ...
                <div style={{ margin: 0 }}>
                    ...
                    {results.length > 0 && (
                        <div>
                            ...
                            {/* <CSVLink filename="All-Sales.csv" data={results}>
                                Export
                            </CSVLink> */}
                            {/* <br />
                            <br />
                            <br /> */}
                            <table className="w-100 m-auto" border="1">
                                <thead>
                                    <tr>
                                        <th>Delete</th>
                                        <th>DD</th>
