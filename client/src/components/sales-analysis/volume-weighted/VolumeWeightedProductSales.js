...
const VolumeWeightedProductSales = ({ location }) => {
    ...
    const handleExportClick = () => {
        exportData(
            table.current,
            "Volume Weighted Product Sales",
            `volume-weighted-product-sales-${request_year}.xlsx`
        );
    };
        ...
        (async () => {
            ...
            try {
                ...
                let response = await axios.get(
                    `${baseURL}/sales/get-volume-weighted-sales`,
                    config
                );
                setResponse_data({
...
export default VolumeWeightedProductSales;
